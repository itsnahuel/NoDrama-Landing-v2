...
const RetroEffect = forwardRef((props, ref) => {
  ...
  return React.createElement(WrappedRetro, { ref, colorNum, pixelSize });
});
...
function DitheredWaves({
  ...
  return React.createElement(
    ...
    React.createElement(
      EffectComposer,
      null,
      React.createElement(RetroEffect, { colorNum, pixelSize })
    ),
    React.createElement(
      "mesh",
      {
...
function Dither({
  ...
  return React.createElement(
    ...
    React.createElement(DitheredWaves, {
      waveSpeed,
      waveFrequency,
      waveAmplitude,
      waveColor,
